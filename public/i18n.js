...
const OG_I18N = {
  fr: {
    ...
    "s00.h2": "Corpus",
    "s00.lead":
      "Mémoire de traduction indexée en production : 113 095 segments parallèles officiels suisses (Fedlex + regestes TF), complétés à la demande par TERMDAT, IATE et EUR-Lex lorsque l'anglais est impliqué.",
    "s00.totalLabel": "segments parallèles indexés",
    "s00.panelBundled": "Sources bundlées (TM suisse)",
    "s00.panelPairs": "Paires linguistiques",
    ...
    "s00.liveTag": "API live",
    "s00.langs311": "DE · FR · IT",
    "s00.loadError": "Statistiques du corpus indisponibles.",
    "s00.src.fedlex": "Fedlex (RS)",
    "s00.src.slds": "Tribunal fédéral (SLDS)",
    "s00.src.termdat": "TERMDAT",
    "s00.src.iate": "IATE",
    "s00.src.eurlex": "EUR-Lex",
    "s01.h2": "Recherche",
    "s01.lead":
  ...
  de: {
    ...
    "s00.h2": "Korpus",
    "s00.lead":
      "Indiziertes Produktions-Translation-Memory: 113 095 amtliche parallele Schweizer Segmente (Fedlex + BGE-Regesten), ergänzt bei Englisch live durch TERMDAT, IATE und EUR-Lex.",
    "s00.totalLabel": "indexierte Parallelsegmente",
    "s00.panelBundled": "Gebündelte Quellen (CH-TM)",
    "s00.panelPairs": "Sprachpaare",
    ...
    "s00.liveTag": "Live-API",
    "s00.langs311": "DE · FR · IT",
    "s00.loadError": "Korpusstatistiken nicht verfügbar.",
    "s00.src.fedlex": "Fedlex (SR)",
    "s00.src.slds": "Bundesgericht (SLDS)",
    "s00.src.termdat": "TERMDAT",
    "s00.src.iate": "IATE",
    "s00.src.eurlex": "EUR-Lex",
    "s01.h2": "Suche",
  ...
  en: {
    ...
    "s00.h2": "Corpus",
    "s00.lead":
      "Indexed production translation memory: 113,095 official parallel Swiss segments (Fedlex + Federal Supreme Court regestes), supplemented on demand by TERMDAT, IATE and EUR-Lex when English is involved.",
    "s00.totalLabel": "indexed parallel segments",
    "s00.panelBundled": "Bundled sources (Swiss TM)",
    "s00.panelPairs": "Language pairs",
    "s00.panelLive": "Live backbones (MCP)",
    ...
    "s00.liveTag": "live API",
    "s00.langs311": "DE · FR · IT",
    "s00.loadError": "Corpus statistics unavailable.",
    "s00.src.fedlex": "Fedlex (SR)",
    "s00.src.slds": "Federal Supreme Court (SLDS)",
    "s00.src.termdat": "TERMDAT",
    "s00.src.iate": "IATE",
    "s00.src.eurlex": "EUR-Lex",
    "s01.h2": "Search",
